...
class AngularMathieu(Protocol):  # pylint: disable=too-few-public-methods
    """Angular Mathieu"""

    def __call__(self, m: Any, q: Any, η: Any, *, p: int = 0) -> Any:
        ...
...
class RadialMathieu(Protocol):  # pylint: disable=too-few-public-methods
    """Radial Mathieu"""

    def __call__(self, m: Any, q: Any, ξ: Any, *, p: int = 0) -> Any:
        ...
