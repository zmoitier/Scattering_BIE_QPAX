""" BIE for Helmholtz exterior Dirichlet
...
def helmholtz_dirichlet_pqr(boundary, k, trace, nb, matrix=False):
    """
    μ, c, θ = helmholtz_dirichlet_pqr(boundary, k, trace, nb, matrix=False)
...
def helmholtz_dirichlet_mpqr(boundary, k, trace, nb, matrix=False):
    """
    μ, c, θ = helmholtz_dirichlet_mpqr(boundary, k, trace, nb, ε, matrix=False)
...
def helmholtz_dirichlet_qpax(boundary, k, expan_trace, N, matrix=False):
    """
